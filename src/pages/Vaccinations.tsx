...
import { Plus, Syringe, Calendar, Download, Bell, QrCode, ArrowLeft } from 'lucide-react';
...
const Vaccinations = () => {
  ...
  // Mock vaccination data generated by "AI"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">Carnet de Vacunación</h1>
                <p className="text-muted-foreground text-sm">Plan personalizado con IA</p>
              </div>
            </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Este plan de vacunación fue personalizado para <strong>{selectedPet.name}</strong> ({selectedPet.breed}, {selectedPet.age} meses) 
                        según las recomendaciones veterinarias y normativas locales.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-2xl font-bold text-foreground">{selectedPetPlan.applied.length}</p>
          ...
          <Card className="mt-8">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground text-sm max-w-md mx-auto">
                Elige una mascota arriba para ver su carnet de vacunación personalizado y el plan generado con IA
              </p>
            </CardContent>
          </Card>
        )}
